...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        response = self.client.get(reverse('mySite:index'))
        self.assertQuerysetEqual(response.context['latest_question_text'],['<Question: Past question.>'])
    ...
    def test_two_past_questions(self):
        ...
        response = self.client.get(reverse('mySite:index'))
        self.assertQuerysetEqual(response.context['latest_question_text'],['<Question: Past question 2.>', '<Question: Past question 1.>'])
